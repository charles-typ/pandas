...
df2 = pd.DataFrame({'A': [1.1, 2.1, 1.1, 2.1],
                   'B': [13, 12, 11, 10]}, columns=['A', 'B'])

#print(df.pipeline_groupby)
#print(df.groupby)
#print(df.groupby('A').sum)
groupbyobject, table = df.pipeline_groupby('A')
(ret, inter), table = groupbyobject.pipeline_sum()
groupbyobject, table = df2.pipeline_groupby('A', hash_table=table)
(ret2, inter2), table = groupbyobject.pipeline_sum(inter)
#print(ret)
#print(table)
#print(inter)
#
